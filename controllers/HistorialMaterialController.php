...
class HistorialMaterial
{
    ...
    public function index()
    {
        ...
        $HistorialMaterial = new HistorialMaterialModel();
    ...
    public function getCountByGenre($param){
        ...
        $HistorialMaterial=new HistorialMaterialModel();
        //Acción del modelo a ejecutar
        $response=$HistorialMaterial->getCountByMaterial($param);
        //Verificar respuesta
        if(isset($response) && !empty($response)){
            //Armar el json
            $json=array(
    ...
    public function getHistorialMaterialByMaterial($param){
        //Instancia del modelo
        $genre=new MaterialModel();
        //Acción del modelo a ejecutar
        $response=$genre->getHistorialMaterialsbyGenre($param);
        //Si hay respuesta
        if(isset($response) && !empty($response)){
            //Armar el json
            $json=array(
